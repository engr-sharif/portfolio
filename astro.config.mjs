...
// DEPLOY TARGET: user site at https://faizashaheen209.github.io/
// The repo is named `faizashaheen209.github.io` (a user-pages repo), so Pages
...
export default defineConfig({
  site: 'https://faizashaheen209.github.io',
  base: '/',
  output: 'static',
